...
Run script `modis\_aod\_add\_utc\_to\_csv.py`. This will create columns "year", "month", "day", "hour_min" in each .csv file and populate the values. These values are taken from the file name and correspond to UTC.
...
Create another column in Postgres table with the correct TZ value from the \href{https://en.wikipedia.org/wiki/List_of_tz_database_time_zones}{tz database}. 
