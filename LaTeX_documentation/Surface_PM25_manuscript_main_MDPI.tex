% MDPI template downloaded from https://www.mdpi.com/authors/latex
...
% MMM considering data, atmosphere, or environments, 
...
\Title{Daily PM\textsubscript{2.5} concentration estimates by ZIP code in 11 western states wildfire and non-wildfire, 2008-2014}%{Title}
...
\bibliography{ReidGroupReferences}%{your_external_BibTeX_file}
