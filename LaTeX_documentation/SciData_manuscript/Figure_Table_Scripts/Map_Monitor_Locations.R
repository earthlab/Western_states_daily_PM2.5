...
if (exists(LatexFileName)) {
  ...
  LaTex_code_4_figure.fn(LatexFileName = LatexFileName, title_string = caption_string, file_sub_label = file_sub_label, plot_name_extension = plot_name_extension, output.directory.short = output.directory.short, image_format = "jpg", ClearPage = ClearPage)
