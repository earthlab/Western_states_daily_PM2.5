...
\title{Daily PM\textsubscript{2.5} concentration estimates by ZIP code in 11 western states wildfire and non-wildfire, 2008-2018} %\title{Data Descriptor Title (110 character maximum, inc. spaces)}
