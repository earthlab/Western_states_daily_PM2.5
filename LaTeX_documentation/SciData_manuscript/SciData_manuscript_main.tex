...
% better temporal prediction through the use of a nonlinear function (cosine) on day of year, (4) 
...
Satellite Aerosol Optical Depth (AOD) is a measure of particle loading in the atmosphere from the ground to the satellite. We obtained daily estimates of %Aerosol Optical Depth (AOD)from 
...
\begin{figure} 
\centering  
\includegraphics[width=0.77\textwidth]{Fig2_choropleth_4-panel_CountyPM25median.pdf} 
