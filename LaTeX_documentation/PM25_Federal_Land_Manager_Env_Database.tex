...
\noindent Downloading IMPROVE Aerosol, RHR II (New Equation) data:
\begin{enumerate}
...
\item Options: Text File; Generate one file containing all the data; Comma delimited, Standard (``wide'' format); Data \& Metadata, Display Column Headers, Display Section Titles, String Quotes: Double Quotes, Missing Values -9999; Date Format: 3/14/2002; Display Results: In a separate browser window; Show Report Log
\item Submit
\end{enumerate}
