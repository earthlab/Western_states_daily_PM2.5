...
\item Process\_NAM\_data\_step3.R merges all of the files from step 2 into a single file and adds a column at the beginning giving the UTC time stamp. This script will take approximately 20 minutes (runs in serial). 
...
\item Process\_NAM\_data\_step5.R merges the 4 time steps to give a 24-hr summary. Min, max, mean, etc. is set in MeteoVariabesNAM.csv. This script is expected to take a little over an hour on 16-cores.
