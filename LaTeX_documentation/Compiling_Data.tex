...
The following is a list of the quality cuts and changes made to the data:
	...
	\item Remove all negative hourly observations (and record the number of positive hourly observations) in each day of Utah DEQ data before aggregating to daily averages. 
...
\item part g: zip code (ZCTA5), county, and census tract centroids for full study period
\end{enumerate}
