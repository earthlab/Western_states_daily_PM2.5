...
\item \textbf{to be written} given listing of all lat/lon/datums in PM2.5, reproject these into a single datum (Equal Area Albers) (Ellen doing this in Python)
