...
origpath = 'C:\\Users\\elco2649\\Documents\\GASP_AOD\\step_3\\'
outpath = 'C:\\Users\\elco2649\\Documents\\GASP_AOD\\step_4a\\'
...
for item in filelist[:3]: #used to be through 10
    try:
        print(item)
        ...
        with open(item, 'r') as csvfile: #had to change to 'r' from 'rb'
