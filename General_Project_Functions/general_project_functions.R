...
define_study_constants.fn <- function(constant_interest) {
  ...
  CARB_Mobile_flow_threshold_upper <- 16.7+0.02*16.7 # flow should be within 2% of 16.7 L/min per email from Joseph McCormack (CARB) on June 24, 2019
  CARB_Mobile_flow_threshold_lower <- 16.7-0.02*16.7
  RHi_threshold_upper <- 45 # RHi should be less than 45% per email from Joseph McCormack (CARB) on June 24, 2019
  DRI_flow_threshold_upper <- 2.0+0.02*2.0 # flow should be within 2% of 16.7 L/min per email from Joseph McCormack (CARB) on June 24, 2019
  DRI_flow_threshold_lower <- 2.0-0.02*2.0
