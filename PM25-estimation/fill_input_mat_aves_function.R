# fill_input_mat_aves.fn <- function(this_day_all_combined_true_dup,input_mat5_aves,rstart_aves,input_mat4_colocated,rstart_colocated,lat_tolerance_threshold,lon_tolerance_threshold, this_day) 
fill_input_mat_aves.fn <- function(this_day_all_combined_true_dup,input_mat5_aves,rstart_aves, lat_tolerance_threshold,lon_tolerance_threshold, this_day) {
  ...
  # input average 
  input_mat5_aves[rstart_aves:rstop_aves,c("PM2.5_Obs")] <- as.numeric(mean(this_day_all_combined_true_dup$PM2.5_Obs)) 
  ...
  input_mat5_aves[rstart_aves:rstop_aves,c("Lon")] <- as.numeric(mean(this_day_all_combined_true_dup$Lon)) # input average 

  # Datum: input value
  input_mat5_aves[rstart_aves:rstop_aves,("NewDatum")] <- unique(this_day_all_combined_true_dup$NewDatum) # input Datum
  ...
  input_mat5_aves[rstart_aves:rstop_aves,c("Date_Local")] <- as.character(unique(this_day_all_combined_true_dup$Date_Local)) # input unique value
  ...
  input_mat5_aves[rstart_aves:rstop_aves,c("Year")] <- as.numeric(mean(this_day_all_combined_true_dup$Year)) # input average 
  ...
  input_mat5_aves[rstart_aves:rstop_aves,c("Month")] <- as.numeric(mean(this_day_all_combined_true_dup$Month)) # input average 
  ...
  input_mat5_aves[rstart_aves:rstop_aves,c("Day")] <- as.numeric(mean(this_day_all_combined_true_dup$Day)) # input average 
  ...
  input_mat5_aves[rstart_aves:rstop_aves,c("State_Code")] <- as.numeric(mean(this_day_all_combined_true_dup$State_Code)) # input average 
  ...
  input_mat5_aves[rstart_aves:rstop_aves,c("County_Code")] <- as.numeric(mean(this_day_all_combined_true_dup$County_Code)) # input average 
  ...
  input_mat5_aves[rstart_aves:rstop_aves,c("Site_Num")] <- as.numeric(mean(this_day_all_combined_true_dup$Site_Num)) # input average 
  # Parameter Code: input mean value of Parameter Code
  input_mat5_aves[rstart_aves:rstop_aves,c("Parameter_Code")] <- as.numeric(mean(this_day_all_combined_true_dup$Parameter_Code))#101502
  # POC: no check statement for POC since we know they are different - take the average and multiply by 10 as new POC value
  input_mat5_aves[rstart_aves:rstop_aves,c("POC")] <- "multiple" #as.numeric(mean(this_day_all_combined_true_dup$POC)) # input average 
  ...
  input_mat5_aves[rstart_aves:rstop_aves,c("Parameter_Name")] <- all_PNs # input composite of data
  rm(all_PNs)
  
  var_interest <- "Sample_Duration"
  all_Vars <- concatinate_within_column.fn(var_interest, this_day_all_combined_true_dup) 
  input_mat5_aves[rstart_aves:rstop_aves,c(var_interest)] <- all_Vars # input composite of data
  ...
  input_mat5_aves[rstart_aves:rstop_aves,c("Observation_Count")] <- as.numeric(sum(this_day_all_combined_true_dup$Observation_Count)) # input average 
  ...
  input_mat5_aves[rstart_aves:rstop_aves,c("Observation_Percent")] <- as.numeric(sum(this_day_all_combined_true_dup$Observation_Percent)) # input average 
  ...
  input_mat5_aves[rstart_aves:rstop_aves,c("X1st_Max_Value")] <- as.numeric(mean(this_day_all_combined_true_dup$X1st_Max_Value)) # input average 
  # X1st_Max_Hour: input NA for X1st_Max_Hour, taking an average of hours of the day seems meaningless
  input_mat5_aves[rstart_aves:rstop_aves,c("X1st_Max_Hour")] <- NA 
  ...
  input_mat5_aves[rstart_aves:rstop_aves,c("AQI")] <- as.numeric(mean(this_day_all_combined_true_dup$AQI)) # input average 
  ...
  input_mat5_aves[rstart_aves:rstop_aves,c("State_Abbrev")] <- as.character(unique(this_day_all_combined_true_dup$State_Abbrev)) # input unique value
  ...
  input_mat5_aves[rstart_aves:rstop_aves,c("Winter")] <- as.numeric(mean(this_day_all_combined_true_dup$Winter)) # input average 
  ...
  input_mat5_aves[rstart_aves:rstop_aves,c("Data_Source_Counter")] <- as.numeric(mean(this_day_all_combined_true_dup$Data_Source_Counter)*-1) # input average times -1
  ...
  input_mat5_aves[rstart_aves:rstop_aves,c("Composite_of_N_rows")] <- as.numeric(sum(this_day_all_combined_true_dup$Composite_of_N_rows)) # input average 
  ...
  input_mat5_aves[rstart_aves:rstop_aves,c("N_Negative_Obs")] <- as.numeric(sum(this_day_all_combined_true_dup$N_Negative_Obs)) # input average 
  ...
  input_mat5_aves[rstart_aves:rstop_aves,c("flg.Lat")] <- as.character(unique(this_day_all_combined_true_dup$flg.Lat)) # input unique value
  ...
  input_mat5_aves[rstart_aves:rstop_aves,c("flg.Lon")] <- as.character(unique(this_day_all_combined_true_dup$flg.Lon)) # input unique value
  ...
  input_mat5_aves[rstart_aves:rstop_aves,c("Type")] <- as.character(unique(this_day_all_combined_true_dup$Type)) # input unique value
  ...
  input_mat5_aves[rstart_aves:rstop_aves,c("flg.Type")] <- as.character(unique(this_day_all_combined_true_dup$flg.Type)) # input unique value
  ...
  input_mat5_aves[rstart_aves:rstop_aves,c("flg.Site_Num")] <- as.character(unique(this_day_all_combined_true_dup$flg.Site_Num)) # input unique value
  ...
  input_mat5_aves[rstart_aves:rstop_aves,c("flg.PM25_Obs")] <- as.character(unique(this_day_all_combined_true_dup$flg.PM25_Obs)) # input unique value
  ...
  input_mat5_aves[rstart_aves:rstop_aves,c("l.m.Ave..Air.Flw")] <- as.numeric(mean(this_day_all_combined_true_dup$l.m.Ave..Air.Flw)) # input average 
  ...
  input_mat5_aves[rstart_aves:rstop_aves,c("flg.AirFlw")] <- as.character(unique(this_day_all_combined_true_dup$flg.AirFlw)) # input unique value
  ...
  input_mat5_aves[rstart_aves:rstop_aves,c("Deg.C.Av.Air.Temp")] <- as.numeric(mean(this_day_all_combined_true_dup$Deg.C.Av.Air.Temp)) # input average 
  ...
  input_mat5_aves[rstart_aves:rstop_aves,c("X..Rel.Humidty")] <- as.numeric(mean(this_day_all_combined_true_dup$X..Rel.Humidty)) # input average 
  ...
  input_mat5_aves[rstart_aves:rstop_aves,c("flg.RelHumid")] <- as.character(unique(this_day_all_combined_true_dup$flg.RelHumid)) # input unique value
  ...
  input_mat5_aves[rstart_aves:rstop_aves,c("mbar.Barom.Press")] <- as.numeric(mean(this_day_all_combined_true_dup$mbar.Barom.Press)) # input average 
  ...
  input_mat5_aves[rstart_aves:rstop_aves,c("flg.Barom.Press")] <- as.character(unique(this_day_all_combined_true_dup$flg.Barom.Press)) # input unique value
  ...
  input_mat5_aves[rstart_aves:rstop_aves,c("deg.C.Sensor..Int.AT")] <- as.numeric(mean(this_day_all_combined_true_dup$deg.C.Sensor..Int.AT)) # input average 
  ...
  input_mat5_aves[rstart_aves:rstop_aves,c("flg.deg.C.Sensor.Int.AT")] <- as.character(unique(this_day_all_combined_true_dup$flg.deg.C.Sensor.Int.AT)) # input unique value
  ...
  input_mat5_aves[rstart_aves:rstop_aves,c("X..Sensor.Int.RH")] <- as.numeric(mean(this_day_all_combined_true_dup$X..Sensor.Int.RH)) # input average 
  ...
  input_mat5_aves[rstart_aves:rstop_aves,c("flg..SensorIntRH")] <- as.character(unique(this_day_all_combined_true_dup$flg..SensorIntRH)) # input unique value
  ...
  input_mat5_aves[rstart_aves:rstop_aves,c("Wind.Speed.m.s")] <- as.numeric(mean(this_day_all_combined_true_dup$Wind.Speed.m.s)) # input average 
  ...
  input_mat5_aves[rstart_aves:rstop_aves,c("flg.WindSpeed")] <- as.character(unique(this_day_all_combined_true_dup$flg.WindSpeed)) # input unique value
  ...
  input_mat5_aves[rstart_aves:rstop_aves,c("Battery.Voltage.volts")] <- as.numeric(mean(this_day_all_combined_true_dup$Battery.Voltage.volts)) # input average 
  ...
  input_mat5_aves[rstart_aves:rstop_aves,c("flg.BatteryVoltage")] <- as.character(unique(this_day_all_combined_true_dup$flg.BatteryVoltage)) # input unique value
  ...
  input_mat5_aves[rstart_aves:rstop_aves,c("Alarm")] <- as.numeric(mean(this_day_all_combined_true_dup$Alarm)) # input average 
  ...
  input_mat5_aves[rstart_aves:rstop_aves,c("flg.Alarm")] <- as.character(unique(this_day_all_combined_true_dup$flg.Alarm)) # input unique value
  ...
  input_mat5_aves[rstart_aves:rstop_aves,c("InDayLatDiff")] <- as.numeric(mean(this_day_all_combined_true_dup$InDayLatDiff)) # input average 
  ...
  input_mat5_aves[rstart_aves:rstop_aves,c("InDayLonDiff")] <- as.numeric(mean(this_day_all_combined_true_dup$InDayLonDiff)) # input average 
  # PlottingColor: setting value specific to this if-statement
  input_mat5_aves[rstart_aves:rstop_aves,c("PlottingColor")] <- as.character(set_plot_color)
  rstart_aves <- rstop_aves+1 # move counter up
  
  #rm(input_mat5_aves,rstart_aves,rstop_aves) # COMMENT
  
  output_list <- list(input_mat5_aves,rstart_aves)   # return value 
  return(output_list)
}
