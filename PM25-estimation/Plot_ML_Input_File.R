...
#   plot(WestUSmapGeom)
#   
#   print(summary(input_mat2$PM2.5_Obs))
#   these_quartiles <- quantile(input_mat2$PM2.5_Obs)
...
#     # isolate data from this data source (in loop iteration) 
#     if (this_quartile==1) {
#       This_data <- input_mat2[which(input_mat2$PM2.5_Obs>=these_quartiles[1] & input_mat2$PM2.5_Obs<these_quartiles[2] & input_mat2$Month == plot_month), ]
#     }
#       
