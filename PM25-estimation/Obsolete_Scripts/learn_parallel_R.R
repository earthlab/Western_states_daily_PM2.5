# learn to parallize code in R

# work through examples in https://cran.r-project.org/web/packages/foreach/foreach.pdf
...
s <- foreach(d=iter(d, by=
                      '
                    row
                    '
), .combine=rbind) %dopar% d
identical(s, d)
